...
public class MetricsResponse {
    ...
    @JsonProperty("gauge.response.metricsdata")
    private Integer gaugeResponseMetricsdata;

    @JsonProperty("counter.status.200.root")
    private Integer counterStatus200Root;

    @JsonProperty("counter.status.200.metricsdata")
    private Integer counterStatus200Metricsdata;
    ...
    @JsonProperty("gauge.response.metricsdata")
    public Integer getGaugeResponseMetricsdata() {
        return gaugeResponseMetricsdata;
    }

    @JsonProperty("gauge.response.metricsdata")
    public void setGaugeResponseMetricsdata(Integer gaugeResponseMetricsdata) {
        this.gaugeResponseMetricsdata = gaugeResponseMetricsdata;
    }
    ...
    @JsonProperty("counter.status.200.metricsdata")
    public Integer getCounterStatus200Metricsdata() {
        return counterStatus200Metricsdata;
    }

    @JsonProperty("counter.status.200.metricsdata")
    public void setCounterStatus200Metricsdatae(Integer counterStatus200Metricsdata) {
        this.counterStatus200Metricsdata = counterStatus200Metricsdata;
    }
