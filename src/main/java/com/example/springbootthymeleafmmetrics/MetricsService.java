...
public class MetricsService {
    ...
    public MetricsResponse getMetricsResponse() throws JSONException {
    ...
    private MetricsResponse formateMatricsResponse(JSONObject jsonObject) throws JSONException {
        ...
        responseJson.put("counterStatus200Metricsdata",
                jsonObject.has("counter.status.200.metricsdata") ? jsonObject.get("counter.status.200.metricsdata") : 0);
        ...
        responseJson.put("gaugeResponseMetricsdata",
                jsonObject.has("gauge.response.metricsdata") ? jsonObject.get("gauge.response.metricsdata") : 0);
